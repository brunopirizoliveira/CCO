...
$tpl->assignInclude('content','../view/inativos.html');
...
$total = new MapaDAO();
$total = $total->getTotalMapaInativos($where);
...
->setTitle("Frotas Inativos - Tecnologias Embarcadas - CCO - Stefani")
->setSubject("Frotas Inativos - Tecnologias Embarcadas")
->setDescription("Frotas Inativos - Tecnologias Embarcadas");
...
$FiltrosDAO = $FiltrosDAOP->lista('filial', 'I');
...
/* Filtro OPERAÇÃO */
$FiltrosDAO = $FiltrosDAOP->lista('operacao', 'I');
...
/* Filtro TIPO */
$FiltrosDAO = $FiltrosDAOP->lista('tipo', 'I');
...
$MapaDAO = new MapaDAO();
$MapaDAO = $MapaDAO->getDadosMapaInativos($inicio, $final, $where);
...
$relMapaDAO = $relMapaDAO->getDadosMapaInativos(0, $total, $where);
...
if($rel){
	...
	header("Content-Disposition: attachment; filename=tecnologias_embarcadas-inativos-".date("Ymd-His").".xls");
